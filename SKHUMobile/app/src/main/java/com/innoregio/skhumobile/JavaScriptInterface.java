...
public class JavaScriptInterface {
    ...
    private void convertBase64StringToPdfAndStoreIt(String base64PDf) throws IOException {
        ...
        final File dwldsPath = new File(Environment.getExternalStoragePublicDirectory(
                Environment.DIRECTORY_DOWNLOADS) + "/download_" + currentDateTime + "_.pdf");
        ...
        if(dwldsPath.exists()) {
            NotificationCompat.Builder b = new NotificationCompat.Builder(context, "MY_DL");
                    ...
                    b.setSmallIcon(R.drawable.innoregio_logo);
                    b.setContentTitle("Download");
                    b.setContentText("Download finished");
